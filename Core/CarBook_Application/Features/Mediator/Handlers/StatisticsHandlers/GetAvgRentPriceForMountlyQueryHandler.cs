...
{
    public class GetAvgRentPriceForMountlyQueryHandler : IRequestHandler<GetAvgRentPriceForMountlyQuery, GetAvgPriceForMountlyQueryResult>
    {
        ...
        public async Task<GetAvgPriceForMountlyQueryResult> Handle(GetAvgRentPriceForMountlyQuery request, CancellationToken cancellationToken)
        {
            var value = _repository.GetAvgRentPriceForMountly();
            return new GetAvgPriceForMountlyQueryResult
            {
                AvgPriceForMountly = value,
            };
        }
    }
}
