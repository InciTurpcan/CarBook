...
namespace CarBook_Persistence.Migrations
{
    ...
    [Migration("20240227235336_mig_add_location_reservation_relation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Banner", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarDescription", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarFeature", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarPricing", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Category", b =>
                {
                    b.Property<int>("CategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Contact", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Feature", b =>
                {
                    b.Property<int>("FeatureID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.FooterAddress", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Pricing", b =>
                {
                    b.Property<int>("PricingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.RentACar", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.RentACarProccess", b =>
                {
                    b.Property<int>("RentACarProccessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RentACarProccessId"));
                    ...
                    b.HasKey("RentACarProccessId");

                    b.HasIndex("CarId");

                    b.HasIndex("CustomerId");

                    b.ToTable("RentACarProccess");
                });

            modelBuilder.Entity("CarBook_Domain.Entities.Reservation", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Service", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.SocialMedia", b =>
                {
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Blog", b =>
                {
                    b.HasOne("CarBook_Domain.Entities.Author", "Author")
                        .WithMany("Blogs")
                        .HasForeignKey("AuthorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook_Domain.Entities.Category", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Car", b =>
                {
                    b.HasOne("CarBook_Domain.Entities.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarDescription", b =>
                {
                    b.HasOne("CarBook_Domain.Entities.Car", "Car")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarFeature", b =>
                {
                    ...
                    b.HasOne("CarBook_Domain.Entities.Feature", "Feature")
                        .WithMany("CarFeatures")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.CarPricing", b =>
                {
                    ...
                    b.HasOne("CarBook_Domain.Entities.Pricing", "Pricing")
                        .WithMany("CarPricings")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.RentACar", b =>
                {
                    ...
                    b.HasOne("CarBook_Domain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.RentACarProccess", b =>
                {
                    b.HasOne("CarBook_Domain.Entities.Car", "Car")
                        .WithMany("RentACarProccesses")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook_Domain.Entities.Customer", "Customer")
                        .WithMany("RentACarProccesses")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Reservation", b =>
                {
                    b.HasOne("CarBook_Domain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservation")
                        .HasForeignKey("DropOffLocationID");

                    b.HasOne("CarBook_Domain.Entities.Location", "PickUpLocation")
            ...
            modelBuilder.Entity("CarBook_Domain.Entities.Car", b =>
                {
                    ...
                    b.Navigation("RentACarProccesses");
